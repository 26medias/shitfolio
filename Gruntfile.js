module.exports = function (grunt) {
    ...
    const DIST_DIR = 'exe4/';
    const APP_NAME = 'Prizeout Workspaces';
    const PLATFORM = 'win32';//'all';
    const ARCH = 'all';
    const ELECTRON_VERSION = '1.2.3';
    const USE_ASAR = true;

    var toggleCommentsFiles = {files:{}};
    toggleCommentsFiles.files[BUILD_DIR + 'index.html'] = 'index-build.html';
            ...
            copy: {
                electron_app: {
                    files: [
                        {
                            expand: true,
                            src: ['index-build.html', 'main.js', 'package.json', 'scripts/**/*.css'],
                            dest: BUILD_DIR
                        }
                    ]
                },
